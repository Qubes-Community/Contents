The content below will eventually has been updated to reflect the newer 4.1 release and QWT recent development - see Installing and Using Windows-based VMs in Qubes R4.1
